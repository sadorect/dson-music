...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        <div class="p-6">
            <h1 class="text-2xl font-semibold mb-6">Edit Admin User</h1>
            ...
            <form action="{{ route('admin.admins.update', $admin) }}" method="POST">
                ...
                <div id="permissions_section" class="mb-6 p-4 bg-gray-50 rounded-lg {{ old('is_super_admin', $admin->is_super_admin) ? 'hidden' : '' }}">
                            ...
                            <div class="flex items-start">
                                <div class="flex items-center h-5">
                                    <input type="checkbox" id="permission_{{ $key }}" name="permissions[]" value="{{ $key }}"
                                           {{ in_array($key, old('permissions', $admin->admin_permissions)) ? 'checked' : '' }}
                                           class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                                </div>
