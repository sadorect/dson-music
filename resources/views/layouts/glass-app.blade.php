        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <a href="{{ route('home') }}" class="flex items-center gap-2 text-xl font-bold text-gray-800 hover:text-primary-500 transition-colors" wire:navigate>
                    <svg class="w-7 h-7 text-primary-500" fill="currentColor" viewBox="0 0 24 24"><path d="M9 3v10.55A4 4 0 107 17V7h8V3H9z"/></svg>
                    <span>GrinMusic</span>
                </a>
                ...
                <div class="col-span-2 sm:col-span-1">
                    ...
                    <div class="flex gap-3">
                        @foreach([
                            ...
                            <a href="#" class="w-8 h-8 rounded-full bg-white/10 hover:bg-primary-500 flex items-center justify-center transition" aria-label="{{ $soc['label'] }}">
