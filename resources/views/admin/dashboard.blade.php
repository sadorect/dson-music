...
@section('content')
<div class="min-h-screen bg-gradient-to-br from-gray-50 via-primary-50/20 to-gray-100">
    <!-- Admin Header -->
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="{{ route('logout') }}" class="text-primary-500 hover:text-primary-600 transition-colors">
                        Logout
                    </a>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div class="bg-glass-base border-glass border/50 backdrop-blur-lg shadow-glass rounded-2xl p-6">
                <div class="flex items-center justify-between">
                    ...
                    <div class="bg-primary-500 rounded-full w-12 h-12 flex items-center justify-center">
                        <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8">
        <div class="bg-glass-base border-glass border/50 backdrop-blur-2xl shadow-glass rounded-2xl p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <a href="{{ route('admin.users') }}" class="bg-primary-500 hover:bg-primary-600 text-white px-4 py-2 rounded-lg text-center transition-colors">
                    Manage Users
                </a>
                <a href="{{ route('admin.artists') }}" class="bg-primary-500 hover:bg-primary-600 text-white px-4 py-2 rounded-lg text-center transition-colors">
                    Manage Artists
                </a>
                <a href="{{ route('admin.tracks') }}" class="bg-primary-500 hover:bg-primary-600 text-white px-4 py-2 rounded-lg text-center transition-colors">
                    Manage Tracks
                </a>
                <a href="{{ route('admin.settings') }}" class="bg-primary-500 hover:bg-primary-600 text-white px-4 py-2 rounded-lg text-center transition-colors">
                    Site Settings
                </a>
            </div>
        </div>
