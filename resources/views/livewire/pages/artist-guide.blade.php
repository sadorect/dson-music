...
<div class="max-w-3xl mx-auto px-4 py-12 space-y-8">
    ...
    <div class="glass-card rounded-2xl p-7 space-y-3">
        ...
        <a href="{{ route('register') }}" wire:navigate class="inline-flex items-center gap-1.5 text-primary hover:text-primary-700 text-sm font-medium transition">
            Get started →
        </a>
    </div>
    ...
    <div class="glass-card rounded-2xl p-7 space-y-3">
        <div class="flex items-center gap-3">
            <span class="w-8 h-8 rounded-full bg-primary text-white text-sm font-bold flex items-center justify-center shrink-0">3</span>
    ...
    <div class="glass-card rounded-2xl p-7 space-y-3">
        <div class="flex items-center gap-3">
            <span class="w-8 h-8 rounded-full bg-primary text-white text-sm font-bold flex items-center justify-center shrink-0">4</span>
    ...
    <div class="glass-card rounded-2xl p-7 space-y-3">
        <div class="flex items-center gap-3">
            <span class="w-8 h-8 rounded-full bg-primary text-white text-sm font-bold flex items-center justify-center shrink-0">5</span>
            <h2 class="text-lg font-bold text-gray-800">Grow Your Audience</h2>
        </div>
        <p class="text-gray-600 leading-relaxed">Share your artist page link with fans. Tracks with high play counts appear in the <a href="{{ route('charts') }}" wire:navigate class="text-primary hover:text-primary-700">Charts</a>. Freshly uploaded tracks appear in <a href="{{ route('new-releases') }}" wire:navigate class="text-primary hover:text-primary-700">New Releases</a>. Engage your listeners and keep uploading.</p>
    </div>
