...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-8">
        ...
        <a href="{{ route('artist.tracks.create') }}" class="dson-btn flex items-center">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($tracks as $track)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">{{ $track->album->title ?? 'Single' }}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex space-x-3">
                                    <button onclick="playTrack('{{ $track->id }}')" class="text-gray-600 hover:text-gray-900">
                                    ...
                                    <form action="{{ route('artist.tracks.destroy', $track) }}" method="POST" class="inline">
                                        @csrf
                                        @method('DELETE')
