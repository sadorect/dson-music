...
<div class="w-full">
    ...
    @php
        ...
        $primaryColor = $artist->is_verified ? 'text-white' : 'text-white/70';
    @endphp
    ...
    <div class="w-full">
        ...
        <div class="flex gap-4 items-center p-4">
            <div class="flex gap-4 items-center">
                <button class="bg-primary-color rounded-full p-3">
                ...
                <button class="text-white/80 text-sm border border-white/30 rounded-full px-4 py-2">
                    Follow
                </button>
